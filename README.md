...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hep_ml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6598&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hep_ml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hep_ml` can be installed with:

```
conda install hep_ml
```

It is possible to list all of the versions of `hep_ml` available on your platform with:
